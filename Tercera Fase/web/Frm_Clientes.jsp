            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    ...
                    <%
                        ...
                        Cliente cliente;
                        cliente = new Cliente();
                        cliente.setId(request.getParameter("idCrearModificar"));

                    %>
                    <form action="CrearModificar" method="post" id="form_AgregarModificar">

                        <div class="form-group">
                            <label for="txtCodigo" class="control-label">Identificacion</label>
                            <input type="txt" id="txtCodigo" name="txtCodigo" value="<%=cliente.getId()%>" class="form-control"/><br>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="txt" id="txtTelefono" name="txtTelefono" value="<%=cliente.getNumeroTelefonico()%>" class="form-control" placeholder="00-00-00-00"/><br>
                        </div>
                        <div class="form-group">
                            <label for="txtCorreo" class="control-label">Correo Electronico</label>
                            <input type="txt" id="txtCorreo" name="txtCorreo" value="<%=cliente.getCorreoElectronico()%>" class="form-control" placeholder="ejemplo@gmail.com"/><br>
                        </div>
